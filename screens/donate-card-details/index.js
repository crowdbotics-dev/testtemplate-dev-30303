  ...
  return <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.body}>
          <TabView tabTitles={["$25", "$50", "$100", "$250", "$500"]} selected={selectedTab} onPress={x => setSelectedTab(x)} style={styles.tabView} />
          <Input text="Payment Options" value={paymentOptions} onChange={text => setPaymentOptions(text)} icon={require("./assets/dropdownIcon.png")} />
          <Input text="Card Number" value={cardNumber} onChange={setCardNumber} />
          <View style={styles.halfInputs}>
            <Input text="Expiration Date" value={cardExpiry} onChange={setCardExpiry} style={styles.input1} containerStyle={styles.inputContainer1} />
            <Input text="CVV" value={cardCvv} onChange={setCardCvv} style={styles.input2} containerStyle={styles.inputContainer2} />
          </View>
          <Input text="Card holder name" value={cardName} onChange={setCardName} />
...
const TabView = ({
  ...
  return <View style={[tabViewStyles.paletteContainer, backgroundColorStyle, style]}>
