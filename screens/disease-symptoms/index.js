      ...
      <View>
        <FlatList ListHeaderComponent={() => <View>
              <View style={styles.cardContainer}>
                ...
                <Image source={require("./assets/sneezingImage.png")} style={styles.cardImage} />
              </View>
              <View style={styles.smallCards}>
                <View style={styles.smallCardContainer}>
                  <Image source={require("./assets/dryCoughImage.png")} style={styles.cardImage} />
                  <Text style={styles.title}>Dry Cough</Text>
                  <Text style={styles.discussionsText}>(124 Discussions)</Text>
                </View>
                <View style={styles.smallCardContainer}>
                  <Image source={require("./assets/feverImage.png")} style={styles.cardImage} />
                  <Text style={styles.title}>Dry Cough</Text>
                  <Text style={styles.discussionsText}>(124 Discussions)</Text>
                </View>
              </View>
        ...
        item
      }) => <Suggestion suggestion={item} />} showsVerticalScrollIndicator={false} horizontal={false} contentContainerStyle={styles.list} />
      </View>
    </View>;
};
