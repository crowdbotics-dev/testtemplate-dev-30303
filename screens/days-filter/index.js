...
const DaysFilter = () => {
  ...
  return <View style={styles.container}>
      ...
      <ScrollView style={styles.list}>
        {days.map((day, index) => <View style={styles.dayContainer} key={index}>
            <Text style={styles.text}>{day}</Text>
            <Pressable onPress={() => handleDayPress(day)}>
              <Image source={selectedDays.includes(day) ? require("./assets/checkboxIconActive.png") : require("./assets/checkboxIcon.png")} style={styles.checkbox} />
            </Pressable>
          </View>)}
      </ScrollView>
