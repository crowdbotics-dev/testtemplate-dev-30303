...
import { Text, View, StyleSheet, Image, TextInput, ScrollView, Pressable } from "react-native";
...
const Filter = () => {
  ...
  return <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <Input text="Filter" value={search} onChange={setSearch} icon={require("./assets/filterIcon.png")} />
        <Separator title={"Desired Days"} />
        <Tile title={"Sunday"} selected={selected.includes("Sunday")} onPress={x => handleSeletion(x)} />
        <Tile title={"Wednesday"} selected={selected.includes("Wednesday")} onPress={x => handleSeletion(x)} />
        <Separator title={"Desired Days"} />
        <Tile title={"Half-Day Mornins"} selected={selected.includes("Half-Day Mornins")} onPress={x => handleSeletion(x)} />
        <Tile title={"Full Day"} selected={selected.includes("Full Day")} onPress={x => handleSeletion(x)} />
        <Separator title={"Budget"} />
        <Tile title={"Per week"} selected={selected.includes("Per week")} onPress={x => handleSeletion(x)} />
        <View style={styles.halfInputs}>
          <Input text="From" value={rangeStart} onChange={setRangeStart} containerStyle={styles.inputContainer} />
          <Input text="To" value={rangeEnd} onChange={setRangeEnd} containerStyle={styles.inputContainer} />
        </View>
        <Slider minimumValue={0} maximumValue={100} minimumTrackTintColor="#a1a1a1" maximumTrackTintColor="#e6e6e6" thumbTintColor="#000" thumbStyle={styles.thumb} step={1} value={50} />
        <Separator title={"Activity"} />
        <Input text="Location" value={location} onChange={setLocation} placeholder="10 miles" />
        ...
        <TabView tabTitles={["Interest", "Interest", "Interest"]} style={styles.tabs} backgroundColor="#fff" selected={0} tabColor="#f1f1f1" />
...
const Separator = ({
  ...
  return <View style={separatorStyles.separator}>
      ...
      <TabView tabTitles={["Choose"]} selected={0} style={separatorStyles.tabView} />
    </View>;
};
...
const Tile = ({
  ...
  return <View style={tileStyles.container}>
      <Text style={tileStyles.title}>{title}</Text>
      <Checkbox style={tileStyles.checkbox} value={selected} setValue={() => onPress(title)} />
    </View>;
};
