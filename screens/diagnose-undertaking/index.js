...
const DiagnoseUndertaking = () => {
  ...
  useEffect(() => {
    setUndertaking1("Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed qui.");
    setUndertaking2("Consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non vnumquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. ");
    setUndertaking3("Ut enim ad minima veniam, quis nostrum exercitationem ullam.Corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur.");
  }, []);
