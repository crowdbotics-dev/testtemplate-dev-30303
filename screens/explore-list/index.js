...
import { Text, View, StyleSheet, FlatList, TextInput, Pressable, Image } from "react-native";
...
const ExploreList = () => {
  ...
  return <View style={styles.container}>
      <FlatList style={styles.list} ListHeaderComponent={() => <View>
            ...
            <TabView tabTitles={["Dates", "Guests", "Filters"]} selected={selectedTab} onPress={index => setSelectedTab(index)} tabColor="#F0F2F7" backgroundColor="#fff" style={styles.tabView} />
            <FlatList data={data} renderItem={({
        item
      }) => <ExploreItem event={item} />} keyExtractor={item => item.id.toString()} horizontal={true} showsHorizontalScrollIndicator={false} />
          ...
          </View>} data={related} renderItem={({
      item
    }) => <RelatedItem event={item} isFav={favourites.includes(item)} onPress={x => handleSelectFavourite(x)} />} keyExtractor={item => item.id.toString()} numColumns={2} columnWrapperStyle={styles.columnWrapper} />
...
const RelatedItem = ({
  ...
  return <View style={relatedItemStyles.container}>
      ...
      <Pressable style={relatedItemStyles.favIconContainer} onPress={() => onPress(event)}>
        <Image source={isFav ? require("./assets/isFavIcon.png") : require("./assets/favIcon.png")} style={relatedItemStyles.favIcon} />
      </Pressable>
    </View>;
};
...
const ExploreItem = ({
  ...
  return <View style={exploreItemStyles.container}>
      ...
      <View style={exploreItemStyles.content}>
        ...
        <View style={exploreItemStyles.details}>
          <Image source={require("./assets/usersJoined.png")} style={exploreItemStyles.icon} />
