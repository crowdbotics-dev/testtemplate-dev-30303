  ...
  return <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.inputTitle}>
          <Image source={require("./assets/userImage.png")} style={styles.inputImage} />
          <Text style={styles.inputText}>Username</Text>
        </View>
        <Input placeholder="Write a reply" value={message} onChangeText={x => setMessage(x)} textArea={true} />
  ...
  return <Pressable style={reviewStyles.container} onPress={() => onPress(item)}>
      <View style={reviewStyles.header}>
        ...
        <View style={reviewStyles.info}>
          ...
          {expanded ? <Text style={reviewStyles.email}>Email: {item.email}</Text> : null}
        </View>
        <Image source={expanded ? require("./assets/menuIconActive.png") : require("./assets/menuIcon.png")} style={reviewStyles.menuIcon} />
      </View>
