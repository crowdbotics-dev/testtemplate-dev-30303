...
const ImageVerification = () => {
  ...
  useEffect(() => {
    ...
    setTips(["Center yourself and smile at the camera", "Take a headshot - from the chest up", "Make sure it's focused andd well lit", "Remove any hats or sunglasses"]);
  }, []);
  ...
  return <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.ratiosContainer}>
          {asapectRatios.map((ratio, index) => <Pressable key={index} style={styles.ratioItem} onPress={() => setSelectedAspectRatio(ratio)}>
