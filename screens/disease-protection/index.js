...
const DiseaseProtection = () => {
  ...
  useEffect(() => {
    ...
    setSuggestions([{
      ...
      description: "Sed lobortis tempor felis sit amet ullamcorper. Morbi in molestie orci. Nulla pharetra consequat nunc, id posuere dolor tincidunt eget.",
      location: "Location"
    }, {
      doctor: "Dr. Full name",
      image: require("./assets/doctorImage.png"),
      ...
      <View>
        <FlatList ListHeaderComponent={() => <View>
              <View>
                ...
                <FlatList data={preventions} keyExtractor={(item, index) => index} renderItem={({
            item
          }) => <Prevention prevention={item} />} horizontal={true} showsHorizontalScrollIndicator={false} />
              </View>
              <View>
                <Text style={styles.heading}>Requirements</Text>
                <FlatList data={requirements} keyExtractor={(item, index) => index} renderItem={({
            item
          }) => <Requirement requirement={item} />} horizontal={true} showsHorizontalScrollIndicator={false} />
              </View>
              <Text style={styles.heading}>Doctor Suggestions</Text>
            </View>} data={suggestions} keyExtractor={(item, index) => index} renderItem={({
        item
      }) => <Suggestion suggestion={item} />} showsVerticalScrollIndicator={false} horizontal={false} />
      </View>
    </View>;
};
...
const Prevention = ({
  ...
  return <View style={preventionStyles.container}>
...
const Requirement = ({
  ...
  return <ImageBackground source={requirement.image} style={requirementStyles.container} imageStyle={requirementStyles.image}>
