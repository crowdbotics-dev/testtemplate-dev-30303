...
const ConnectWallet = () => {
  ...
  return <View style={styles.container}>
      ...
      <View style={styles.wallets}>
        <ScrollView>
          {wallets.map((wallet, index) => <Wallet wallet={wallet} key={index} selected={selectedWallets.includes(wallet)} onPress={() => handleWalletPress(wallet)} />)}
        </ScrollView>
...
const Wallet = ({
  ...
  return <View style={walletStyles.container}>
      <View style={walletStyles.cardBackground}>
        <Text style={walletStyles.name}>{wallet.name}</Text>
        <Pressable onPress={() => onPress(wallet)}>
          <Image source={selected ? require("./assets/checkboxIconActive.png") : require("./assets/checkboxIcon.png")} style={walletStyles.checkbox} />
        </Pressable>
      </View>
