      ...
      <View style={styles.body}>
        <View style={styles.cardContainer}>
          <View style={styles.cardHeader}>
            ...
            <Image source={require("./assets/callIcon.png")} style={styles.icon} />
          </View>
          <View style={styles.recommendationTab}>
            <Image source={require("./assets/userImages.png")} style={styles.userImages} />
          ...
          <Image source={require("./assets/tabsIcon.png")} style={styles.tabsIcon} />
        </View>
      </View>
    </ImageBackground>;
};
