...
const CourseCategoryList = () => {
  ...
  return <View style={styles.container}>
      <View style={styles.searchContainer}>
        <Input text={"Search"} value={search} onChange={x => setSearch(x)} icon={require("./assets/searchBarIcon.png")} />
      </View>
      <View style={styles.separator}>
        <Text style={styles.separatorText}>Design and User Experience</Text>
        <Image source={require("./assets/filterIcon.png")} />
      </View>
      <FlatList style={styles.courseList} data={courseList} renderItem={({
      item
    }) => <Course course={item} />} numColumns={2} keyExtractor={item => item.id.toString()} columnWrapperStyle={styles.columnWrapper} />
      <Footer images={[require("./assets/homeIconActive.png"), require("./assets/starIcon.png"), require("./assets/searchIcon.png"), require("./assets/settingsIcon.png"), require("./assets/bellIcon.png")]} active={3} hideTitle={true} />
    </View>;
};
...
const Course = ({
  ...
  return <View style={courseStyles.container}>
      ...
      {course.isfavorite ? <Image source={require("./assets/favIcon.png")} style={courseStyles.favIcon} /> : null}
...
const Input = props => {
  return <View style={inputStyles.inputContainer}>
      ...
      <TextInput style={inputStyles.input} placeholder={props.placeholder ? props.placeholder : "Enter"} value={props.value} onChangeText={text => props.onChange(text)} placeholderTextColor={props.placeholderTextColor ? props.placeholderTextColor : "#9B9B9B"} editable={props.editable !== false} autoCapitalize="none" autoCorrect={false} />
