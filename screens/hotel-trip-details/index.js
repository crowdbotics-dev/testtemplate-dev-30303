  ...
  useEffect(() => {
    setHotelDetails({
      ...
      features: [{
        ...
        description: "15 recent guests complimented Brooke Calgefor outstanding hospitality."
      }, {
        name: "Great Check-in Experience",
        description: "98% of recent guests gave check-in process 5 star rating"
      }, {
      ...
      reviews: [{
        ...
        image: require("./assets/userImage.png"),
        date: "June 2022",
        review: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eros sed leo, ultrices pellentesque nibh neque. Sed tempus ut mi a. Turpis."
      }]
    });
    setAllAmenities(["Wifi", "Parking", "Air Conditioning", "Cable TV", "Carbon monoxide detector", "Smoke detector", "Heating", "Washing machine"]);
  }, []);
  const icons = [{
    name: "Wifi",
  ...
  return <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.featuresContainer}>
          {hotelDetails.features && hotelDetails.features.map((item, index) => <View style={styles.featureItem} key={index}>
                <Text>{item.name}</Text>
          ...
          <Button buttonText="Contact host" color="#f2f2f2" outlineColor="#000" textColor="#000" hideShadow={true} style={styles.button} />
        </View>
        <View style={styles.spaceDetailsContainer}>
          ...
          <View style={styles.spaceItemsContainer}>
            {hotelDetails.space && hotelDetails.space.map((item, index) => <View style={styles.spaceItem} key={index}>
        ...
        <View style={styles.amenitiesContainer}>
          ...
          <View style={styles.amenitiesContent}>
            {allAmenities && allAmenities.map((item, index) => <View style={styles.amenityItem} key={index}>
        ...
        <View style={styles.locationContainer}>
          ...
          <Image source={hotelDetails.locationImage} style={styles.locationImage} />
        </View>
