      ...
      <ScrollView style={styles.body}>
        ...
        <View style={styles.symptomItem}>
          ...
          <View style={styles.halfInputs}>
            <Input text="Faremheit for US Celcius for all other" value={temperature} onChange={x => setTemperature(x)} containerStyle={styles.input} />
        ...
        <View style={styles.symptomItem}>
          ...
          <View style={styles.halfInputs}>
            <Input text="How long have you had your cough?" value={coughtTime} onChange={x => setCoughtTime(x)} containerStyle={styles.input} />
            <Input text="Is your cought wet or dry?" value={wetCought} onChange={x => setWetCought(x)} containerStyle={styles.input} />
          </View>
          <BinaryQuestion question="Are you choughing up mucus?" value={isMucus} setValue={x => setIsMucus(x)} />
...
const SymptomLevel = ({
  ...
  return <View style={symptomLevelStyles.container}>
      ...
      setLevel(item);
      currentLevel = item;
    }} key={index} style={[symptomLevelStyles.check, giveDimentions(), item === currentLevel ? symptomLevelStyles.fill : null]} />)}
    </View>;
};
